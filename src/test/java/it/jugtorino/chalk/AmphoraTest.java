...
public class AmphoraTest {
  ...
  public void shouldRenameMultiValuesFields() throws Exception {
    ...
    Amphora amphora = new Amphora().add("name", "first").add("name", "second").add("name", "third");
  ...
  public void amphorasWithSameValuesAreEquals() {
    ...
    Amphora first = new Amphora().add("name", "value").add("name", "value");

    Amphora second = new Amphora().add("name", "value").add("name", "value");
  ...
  public void shouldReplaceFieldValue() throws Exception {
    Amphora amphora = new Amphora().add("name", "value1").add("name", "value2");
  ...
  public void shouldApplyFunctionToStringField() throws Exception {
    ...
    Function<String, String> fieldModifier =
  ...
  public void shouldApplyFunctionToObjectField() throws Exception {
    ...
    Function<Integer, Integer> fieldModifier =
  ...
  public void etlExample() throws Exception {
    Function<Integer, Integer> incrementer =
        new Function<Integer, Integer>() {
